import {startAddExpense,addExpense, editExpense, removeExpense,
     setExpenses,startSetExpenses, startRemoveExpenses, startEditExpense} from '../../actions/expenses';
...
test('should  Add Expense to database with defaults', ()=>{
    const store = createMockStore({})
    const expenseData ={
        description:'',
        amount:0,
